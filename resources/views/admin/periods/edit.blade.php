...
<div class="flex justify-between items-center mb-6">
    <div>
        <h2 class="text-2xl font-bold text-gray-900">Periode Bewerken</h2>
        <p class="text-gray-600">Pas de gegevens van de periode aan.</p>
    </div>
...
<div class="bg-white shadow rounded-lg">
    <form action="{{ route('admin.periods.update', $period) }}" method="POST">
        ...
        <div class="p-6 space-y-6">
                ...
                <div class="grid grid-cols-1 gap-6 sm:grid-cols-2">
                    <div>
                        ...
                        <input type="datetime-local" 
                               ...
                               required
                               value="{{ old('enrollment_opens_at', $period->enrollment_opens_at->format('Y-m-d\TH:i')) }}"
                               class="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-primary focus:border-primary">
                    ...
                    <div>
                        ...
                        <input type="datetime-local" 
                               ...
                               required
                               value="{{ old('enrollment_closes_at', $period->enrollment_closes_at->format('Y-m-d\TH:i')) }}"
                               class="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-primary focus:border-primary">
            ...
            <!-- Warning for existing keuzedelen -->
                    ...
                    <div class="flex">
                        ...
                        <div class="ml-3">
                            <p class="text-sm text-yellow-800">
                                Let op: Deze periode heeft {{ $period->keuzedelen->count() }} keuzedelen. 
                                Het aanpassen van datums kan de beschikbaarheid van deze keuzedelen beïnvloeden.
                            </p>
                        </div>
                    </div>
                </div>
