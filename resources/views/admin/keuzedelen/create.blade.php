...
<div class="flex justify-between items-center mb-6">
    <div>
        <h2 class="text-2xl font-bold text-gray-900">Nieuw Keuzedeel Aanmaken</h2>
        <p class="text-gray-600">Vul onderstaande gegevens in om een nieuw keuzedeel aan te maken.</p>
    </div>
            ...
            <div>
                ...
                <div class="mt-4">
                    ...
                    <textarea id="schedule_info" 
                              ...
                              class="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-primary focus:border-primary">{{ old('schedule_info') }}</textarea>
                    @error('schedule_info')
                        <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                    @enderror
                </div>
                    ...
                    @foreach($studyPrograms as $program)
                        <div class="flex items-center">
                            <input type="checkbox" 
                                   ...
                                   value="{{ $program }}"
                                   {{ in_array($program, old('eligible_programs', [])) ? 'checked' : '' }}
