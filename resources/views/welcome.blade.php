    ...
    <body class="min-h-screen bg-gray-50">
        ...
        <div class="gradient-bg py-20">
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div class="text-center">
                    <h1 class="text-5xl font-bold text-white mb-6">Keuzedelen</h1>
                    ...
                    @auth
                        <a href="{{ route('keuzedelen.index') }}" class="bg-white text-purple-600 px-8 py-3 rounded-md font-medium hover:bg-gray-100 transition-colors inline-flex items-center">
                            <i class="fas fa-arrow-right mr-2"></i>Bekijk beschikbare keuzedelen
                        </a>
                    @else
                        <div class="flex flex-col sm:flex-row gap-4 justify-center">
                            <a href="{{ route('login') }}" class="bg-white text-purple-600 px-8 py-3 rounded-md font-medium hover:bg-gray-100 transition-colors inline-flex items-center">
        ...
        <div class="py-16">
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div class="text-center mb-12">
                    <h2 class="text-3xl font-bold text-gray-900 mb-4">Waarom keuzedelen?</h2>
        ...
        <div class="bg-purple-600 text-white py-16">
            <div class="max-w-4xl mx-auto px-4 text-center">
                <h2 class="text-3xl font-bold mb-6">Klaar om je keuzedeel te kiezen?</h2>
        ...
        <footer class="bg-gray-800 text-white py-8">
            <div class="max-w-7xl mx-auto px-4 text-center">
                <p>&copy; {{ date('Y') }} Keuzedeel Systeem - Techniek College Rotterdam. Alle rechten voorbehouden.</p>
                <div class="mt-4 text-sm text-gray-400">
                    Onderdeel van het onderwijsmanagementsysteem voor keuzedeelinschrijvingen
                </div>
            </div>
        </footer>
